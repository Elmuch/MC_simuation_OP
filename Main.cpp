...
int main()
{
    ...
    //test  pricers
    cout <<"Call price: " <<C.Price(Batch1)<<", Put Price: " <<P.Price(Batch1)<<endl;
    cout<<"based on put-call parity: " <<C.Price_par(P.Price(Batch1)) //call price given Put price
    <<" , "<<P.Price_par(C.Price(Batch1))<<endl;        //put price given call price
    cout<< "Price given sig or T: Call: "<<C.Price(C,sig)<<" , Put: "<<P.Price(P,T)<<"\n"<<endl;    //price given volatility or maturity time
...
cout<<"\n---------------Batch2--------------------------------- \n"<<endl;
   ...
   //test  pricers
    cout <<"Call price: " <<C2.Price(Batch2)<<", Put Price: " <<P2.Price(Batch2)<<endl;
    cout<<"based on put-call parity: " <<C2.Price_par(P2.Price(Batch2)) //call price given Put price
    <<" , "<<P2.Price_par(C2.Price(Batch2))<<endl;        //put price given call price
    cout<< "Price given sig or T: Call: "<<C2.Price(C2,sig)<<" , Put: "<<P2.Price(P,T)<<endl;    //price given volatility or maturity time
...
//Batch 3
   ...
   //test  pricers
    cout <<"Call price: " <<C3.Price(Batch3)<<", Put Price: " <<P3.Price(Batch3)<<endl;
    cout<<"based on put-call parity: " <<C3.Price_par(P3.Price(Batch3)) //call price given Put price
    <<" , "<<P3.Price_par(C3.Price(Batch3))<<endl;        //put price given call price
    cout<< "Price given sig or T: Call: "<<C3.Price(C3,sig)<<" , Put: "<<P3.Price(P,T)<<endl;    //price given volatility or maturity time
...
//Batch 4
    ...
    cout <<"Call price: " <<C4.Price(Batch4)<<", Put Price: " <<P4.Price(Batch4)<<endl;
    cout<<"based on put-call parity: " <<C4.Price_par(P4.Price(Batch4)) //call price given Put price
    <<" , "<<P4.Price_par(C4.Price(Batch4))<<endl;        //put price given call price
    cout<< "Price given sig or T: Call: "<<C4.Price(C4,sig)<<" , Put: "<<P4.Price(P,T)<<endl;    //price given volatility or maturity time
...
cout<<"\n------------------Greeks---------------------------" <<endl;
    ...
    PutOption Put(greek);
     ...
     //Test delta
    cout<<"Call delta: "<<Call.CallDelta(S)<<" Putdelta:  "<<Put.PutDelta(S)<<endl;
...
for (double h = 1.0; h>0.1; h-=0.1) //test convergence from 1.0 to 0.1
{
    cout<<"h :"<<h<<" CallDelta: "<<Call.CallDelta_approx(h) //test call delta approximation
